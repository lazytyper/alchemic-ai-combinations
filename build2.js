...
blocks.push('</script></head><body><div class="container"><h1>Alchemic AI elements search</h1><p> <span id="element-count">0</span> elements available</p><div id="inputform"><input id="search" type="text" placeholder="element" autocomplete="off"><button id="searchbtn">Show</button> <label style="margin-left:2em">Search method:</label> <select id="search-method"><option value="0">Fuzzy search</option><option value="1">Contains term (like in game)</option><option value="2">Begins with term (like in game)</option><option value="3">Ends with term</option></select></div><div id="solutions"></div></div></body></html>');
